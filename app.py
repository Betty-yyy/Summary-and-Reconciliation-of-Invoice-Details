...
def analyze_single_file(file_content, file_name):
    ...
    try:
        ...
        total_paid = df[paid_col].sum() if paid_col else (
            total_consumption - total_unpaid if total_unpaid is not None else 0)
